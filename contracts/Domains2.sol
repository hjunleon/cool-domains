...
//   mapping(string => string) public records;
  ...
  constructor(string memory _tld) payable ERC721("Wacker Name Service", "WNS") { //collection name + symbol
    tld = _tld;
  ...
  function register(string calldata name) public payable {
    ...
    string memory finalSvg = string(abi.encodePacked(svgPartOne, _name, svgPartTwo)); // to concat strings
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        _name,
        '", "description": "A domain on the Wacker name service", "image": "data:image/svg+xml;base64,',
